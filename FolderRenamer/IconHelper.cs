...
namespace FolderRenamer
{
    public class IconHelper
    {
        ...
        /// <summary>  
        /// return the icon associated with file  
        /// </summary>  
        /// <param name="pszPath">if the file path is"" </param>  
        /// <param name="dwFileAttributes">0</param>  
        /// <param name="psfi">structure</param>  
        /// <param name="cbSizeFileInfo">size of structure</param>  
        /// <param name="uFlags">enum</param>  
        /// <returns>-1failed</returns>  
        ...
        /// Using driver letter like "D:" we get the icon from Derive.
        /// i believe thar using special folders name the same happens
