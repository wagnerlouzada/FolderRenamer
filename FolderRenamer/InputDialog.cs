...
namespace FolderRenamer
{
    ...
    {
        #region Interface
        public static string ShowDialog(string prompt, string title, string defaultValue = null, int? width = null, int? xPos = null, int? yPos = null)
        {
        ...
        private class InputBoxDialog : Form
        {
            ...
            #region Constructor
            public InputBoxDialog(string prompt, string title, string defaultValue = null, int? width = null, int? xPos = null, int? yPos = null)
            {
                ...
                Size size = graphics.MeasureString(prompt, _lblPrompt.Font).ToSize();
                Size size2 = graphics.MeasureString(defaultValue, _lblPrompt.Font).ToSize();
